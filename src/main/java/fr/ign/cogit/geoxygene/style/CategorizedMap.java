...
public class CategorizedMap {
    ...
    @XmlTransient
    private final Map<Object, Color> usedColors = new HashMap<Object, Color>();
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.usedColors == null) ? 0 : this.usedColors.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        CategorizedMap other = (CategorizedMap) obj;
        ...
        } else if (!this.usedColors.equals(other.usedColors)) {
            return false;
        }
        return true;
    }
